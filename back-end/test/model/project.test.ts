...
test('Given: valid data for project, When: creating a project, Then: project is created with valid name',() => {
    const validName: string = "project1";
    const validId: number = 1;
    const validTeam: Team = new Team({name: "team1", id: 1});
    const project = new Project({name: validName, id: validId, team: validTeam}); 
...
test('Given: bad name for project, When: creating a project, Then: project is not created and error is given',() => {
